...
{
	GraphicVerifyCode code = EvaMain::session->getLoginManager()->getLoginVerifyInfo();
...
{
	GraphicVerifyCode code = EvaMain::session->getLoginManager()->getNextLoginVerifyInfo();
